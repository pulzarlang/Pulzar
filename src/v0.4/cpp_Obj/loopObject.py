...
import cpp_Obj.conditionalObject
class LoopObject:
    ...
    def transpile(self):
        for ast in self.ast:
            ...
            try:
                ...
                if increment == "1": increment = name + "++"
                elif increment == "-1": increment = name + "--"
            except: pass
    ...
    def transpile_scope(self, body_ast, nesting_count, items):
        ...
        for ast in body_ast:
            ...
            if self.check_ast('conditional_statement', ast):
                ...
                condition_obj = cpp_Obj.conditionalObject.ConditionalObject(ast, nesting_count)
